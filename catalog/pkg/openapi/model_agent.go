...
type Agent struct {
	...
	// Catalog source that provides this agent.
	SourceId *string `json:"source_id,omitempty"`
	// Human-readable display name.
	DisplayName *string `json:"displayName,omitempty"`
	// Agent framework (e.g., langgraph, crewai, autogen, a2a).
	Framework *string `json:"framework,omitempty"`
	// Catalog classification (e.g., starter_kit).
	AgentType *string `json:"agentType,omitempty"`
	// Categorization tags for this agent.
	Tags []string `json:"tags,omitempty"`
	// Compatible model identifiers.
	Models []string `json:"models,omitempty"`
	// Agent or framework logo URL.
	Logo *string `json:"logo,omitempty"`
	// URL to the agent source repository.
	RepositoryUrl *string `json:"repositoryUrl,omitempty"`
	// Date when this agent was published.
	PublishedDate *time.Time `json:"publishedDate,omitempty"`
	// Full Markdown documentation for this agent.
